...
class UserAdminConfig(UserAdmin):
    ...
    list_display = ['pk', 'email', 'username', 'first_name', 'gender', 'address', 'phone_number']
    # Searchable fields
    ...
    fieldsets = (
        ('Personal info', {'fields': ('username','first_name','last_name','gender','profile_image', 'address', 'phone_number')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('username', 'gender', 'address', 'phone_number', 'password1', 'password2'),
        }),
    )
